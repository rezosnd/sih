...
const char *ssid = "Nanna";  //ENTER YOUR WIFI SETTINGS
const char *password = "9826816305$#";
//************************************************************************
String postData ; // post array that will be send to the website

String link = "http://192.168.29.37/biometric/getdata.php"; //computer IP or the server domain

// String link = "https://api.thingspeak.com"; //computer IP or the server domain
// String key = "/update?api_key=UIS6RYBWYQFWGNZ0&field1=";
